...
export const DEFAULT_BRAND_RECORDS = [
  ...
  },
  {
    ...
    value: {
      ...
      palettes: {
        cream: {
          name: 'Workshop paper',
          description: 'Warm paper, charcoal ink, and a restrained oxblood accent.',
          tokens: {
            paper: '#f4efe6',
            paper_2: '#ece6d9',
            paper_3: '#e3ddcf',
  ...
  },
  {
    setting_key: 'usage',
    value: {
      accent_rule: 'Oxblood is a mark, not a wash. Use it for small signals, rules, numerals, and moments of emphasis.',
